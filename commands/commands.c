...
static void cmd_help(int argc, char * argv[]) {
  ...
  const entry_t g_hardware[] = {
    ...
    {
      "stack",
      "Core0 stack depth and high-water mark"
    },
    {
      "power",
      "VSYS voltage and battery estimate"
    },
    {
      "gpio",
      "read / write / mode / irq <pin>"
    },
    {
      "led",
      "on | off | toggle | blink [n]"
    },
    {
      "pwm",
      "pwm <pin> <duty 0-100> [freq_hz]"
    },
    {
      "adc",
      "raw ADC read  (ch 0-2, GPIO26-28)"
    },
    {
      "avg",
      "averaged ADC read  [samples]"
    },
    {
      "pull",
      "pull <pin> up | down | none"
    },
    {
      "clock",
      "get / set CPU freq (48-200 MHz)"
    },
    {
      "pin",
      "snapshot of all GPIO states"
    },
    {
      "pinout",
      "ASCII Pico pinout with live states"
    },
    {
      "uid",
      "unique board ID"
    ...
    {
      "oled",
      "SSD1306 128x64 I2C display (GP4/GP5)"
    },
  };
  static
  const entry_t g_buses[] = {
    {
      "i2c",
      "scan [sda scl] | read | write | dump  (default SDA=GP4 SCL=GP5)"
    },
    {
      "spi",
      "init | write | read | xfer"
    },
    {
      "uart",
      "passthrough <baud> <tx> <rx> [timeout_s]"
    },
  };
  static
  const entry_t g_probes[] = {
    {
      "la",
      "logic analyser  <pin> [samples] [us] [trigger]"
    },
    {
      "scope",
      "<pin> <hz> <ms>  clean waveform viewer"
    },
    {
      "detect",
      "scan | uart <pin> | analyze <pin>"
    },
    {
      "imu",
      "MPU6050 read|stream|attitude|calibrate"
    },
  };
  static
  const entry_t g_servo[] = {
    {
      "servo",
      "<pin> <angle> | sweep | bg sweep/goto/stop"
    },
  };
  static
  const entry_t g_audio[] = {
    {
      "tone",
      "<pin> <note|Hz> [ms]  passive buzzer"
    },
    {
      "melody",
      "<pin> <C4:200 E4:200 ...> | elise | canon"
    },
    {
      "morse",
      "<text> [wpm]  blink LED in morse"
    },
    {
      "piano",
      "<pin>  play buzzer from keyboard"
    },
  };
  static
  const entry_t g_scripting[] = {
    {
      "sleep",
      "sleep <ms>"
    },
    ...
    {
      "watch",
      "watch <ms> <command>  run at interval"
    },
    {
      "trigger",
      "trigger <pin> <rise|fall|both> <cmd>"
    },
    {
      "cron",
      "cron <delay_ms> <command>  deferred run"
    },
    {
      "bench",
      "bench <iters> <cmd>  throughput test"
    },
    {
      "time",
  ...
  static
  const entry_t g_flash[] = {
    {
      "flash",
      "read | write | erase <addr>  raw flash"
    },
  };
  static
  const entry_t g_system[] = {
    {
      "reboot",
      "reboot via watchdog"
    },
    {
      "dfu",
      "enter USB DFU (BOOTSEL) mode"
    },
    {
      "fault",
      "info | test  HardFault register dump"
    },
    {
      "drivers",
      "list loaded drivers"
    ...
    {
      "tasks",
      "list / enable / disable background tasks"
    },
    {
      "config",
      "show | set | save | reset"
    ...
    {
      "syslog",
      "show | warn | err | write | clear | stats"
    },
    {
      "jobs",
      "list / cancel background Core1 jobs"
    },
    {
      "date",
      "[set Y M D h m s]  real-time clock"
    },
    {
      "history",
    ...
    {
      "rand",
      "[min] [max]  hardware random number"
    },
  };
  static
  const entry_t g_bluetooth[] = {
    {
      "bt shell",
      "wireless DeckOS terminal over HC-05"
    },
    {
      "bt log",
      "on|off  mirror syslog to BT"
    },
    {
      "bt exec",
    ...
    {
      "bt top",
      "[ms]  stream live stats to BT"
    },
    {
      "bt send",
      "<file>  send VFS file over BT"
    },
    {
      "bt recv",
      "<file>  receive file into VFS"
    },
    {
      "bt sniff",
      "[s]  raw byte sniffer"
    ...
    {
      "bt name",
      "<n>  set module name (AT mode)"
    },
    {
      "bt pin",
      "<n>  set pairing PIN (AT mode)"
    },
    {
      "bt baud",
      "<n>  change UART baud (AT mode)"
    },
    {
      "bt status",
      "show BT state"
  ...
  static
  const entry_t g_wifi[] = {
    {
      "wifi init",
      "[baud]  initialise ESP8266 on UART1"
    },
    {
      "wifi status",
      "show ESP8266 wiring and runtime state"
    },
    {
      "wifi ping",
      "probe module and test connectivity"
    },
    {
      "wifi scan",
    ...
    {
      "wifi join",
      "<ssid> <password>  join a network"
    },
    {
      "wifi ip",
      "show assigned IP / station info"
    },
    {
      "wifi shell",
      "interactive ESP8266 AT shell"
    },
    {
      "wifi deinit",
      "release UART1 from ESP8266"
    },
    {
      "wifi bridge auto",
      "auto-detect ESP firmware type"
    },
    {
      "wifi bridge at",
      "force AT passthrough mode"
    },
    {
      "wifi bridge raw",
      "pass commands without translation"
    },
    {
      "wifi bridge status",
      "show bridge mode and WiFi state"
    },
    {
      "wifi bridge reset",
      "restart the ESP8266"
    ...
    {
      "wifi bridge scan",
      "scan networks via bridge (@scan)"
    },
    {
      "wifi bridge connect",
      "connect using stored SSID via bridge"
    },
    {
      "wifi telnet",
    ...
    {
      "wifi serve",
      "start HTTP server (connect first)"
    },
    {
      "wifi get",
  ...
  const entry_t g_usb[] = {
    {
      "usb",
      "status|list|export|import|sync|rm|format  USB mass-storage disk"
    },
    {
      "hid",
      "type <text>|line <text>|key <COMBO>|enter  act as USB keyboard"
    },
    {
      "console",
      "oled on|off  mirror shell output to the OLED (handheld mode)"
    },
  };
  ...
  static
  const int group_count = (int)(sizeof(groups) / sizeof(group_t));
  static
  ...
  printf("DeckOS v5.0  --  command groups\n");
  printf("====================================================\n\n");
  fflush(stdout);
  for (int g = 0; g < group_count; g++) {
...
static inline void adc_temp_prepare(void) {
  adc_init();
  adc_set_temp_sensor_enabled(true);
  adc_select_input(4);
}

static inline float adc_temp_read_c(void) {
  adc_temp_prepare();
...
static void cmd_temp(int argc, char * argv[]) {
  (void) argc;
  (void) argv;
  float tc = adc_temp_read_c();
  float tf = tc * 9.0f / 5.0f + 32.1f;
...
static void cmd_mem(int argc, char * argv[]) {
  ...
  printf("flash          : %lu KB  (%lu MB)\n", b.flash_kb, b.flash_kb / 1024);
  fflush(stdout);
}
...
static void cmd_memmap(int argc, char * argv[]) {
  ...
  (void) argv;
  board_info_t b = board_detect();
  uint32_t flash_end = 0x10000000 + (b.flash_kb * 1024);
  uint32_t config_sector = flash_end - 4096;
  ...
  printf("=== RP2040 Memory Map  [%s] ===\n", b.name);
  printf("\n[ FLASH  0x10000000 - 0x%08lX  (%lu KB) ]\n",
    flash_end, b.flash_kb);
  ...
  printf("  .flash_binary_end   : 0x%08lX   (%lu KB used)\n",
    ...
    ((uint32_t) & __flash_binary_end -
      (uint32_t) & __flash_binary_start) / 1024);
  printf("  config sector       : 0x%08lX   (last 4 KB)\n", config_sector);
  fflush(stdout);

  printf("\n[ SRAM   0x20000000 - 0x20042000  (%lu KB) ]\n", b.sram_kb);
...
static void cmd_bt(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "init") == 0) {
    ...
    if (baud < 300 || baud > 921600) {
      printf("baud must be 300-921600\n");
      return;
    }
    bt_init(baud);
    return;
  ...
  if (strcmp(argv[1], "shell") == 0) {
    if (!bt_is_ready()) {
      printf("bt: not initialised - run 'bt init'\n");
      return;
    }
  ...
  if (strcmp(argv[1], "baud") == 0) {
    ...
    if (argc < 3) {
      printf("bt baud <rate>  (e.g. 9600 or 115200)\n");
      return;
    }
...
static void cmd_oled(int argc, char * argv[]) {
  ...
  if (strcmp(sub, "fill") == 0) {
    if (argc < 3) {
      printf("usage: oled fill <hex_pattern>\n");
      return;
    }
  ...
  if (strcmp(sub, "contrast") == 0) {
    if (argc < 3) {
      printf("usage: oled contrast <0-255>\n");
      return;
    }
  ...
  if (strcmp(sub, "flip") == 0) {
    if (argc < 4) {
      printf("usage: oled flip <h:0|1> <v:0|1>\n");
      return;
    }
  ...
  if (strcmp(sub, "text") == 0) {
    if (argc < 5) {
      printf("usage: oled text <col> <row> <string>\n");
      return;
    }
  ...
  if (strcmp(sub, "textxy") == 0) {
    if (argc < 5) {
      printf("usage: oled textxy <x> <y> <string>\n");
      return;
    }
    char buf[128] = "";
    for (int i = 4; i < argc; i++) {
  ...
  if (strcmp(sub, "printf") == 0) {
    if (argc < 5) {
      printf("usage: oled printf <col> <row> <fmt...>\n");
      return;
    }
    char buf[128] = "";
    for (int i = 4; i < argc; i++) {
  ...
  if (strcmp(sub, "pixel") == 0) {
    if (argc < 5) {
      printf("usage: oled pixel <x> <y> <0|1>\n");
      return;
    }
  ...
  if (strcmp(sub, "hline") == 0) {
    if (argc < 5) {
      printf("usage: oled hline <x0> <x1> <y>\n");
      return;
    }
  ...
  if (strcmp(sub, "vline") == 0) {
    if (argc < 5) {
      printf("usage: oled vline <x> <y0> <y1>\n");
      return;
    }
  ...
  if (strcmp(sub, "line") == 0) {
    if (argc < 6) {
      printf("usage: oled line <x0> <y0> <x1> <y1>\n");
      return;
    }
  ...
  if (strcmp(sub, "rect") == 0) {
    if (argc < 6) {
      printf("usage: oled rect <x> <y> <w> <h>\n");
      return;
    }
  ...
  if (strcmp(sub, "rectfill") == 0) {
    if (argc < 6) {
      printf("usage: oled rectfill <x> <y> <w> <h>\n");
      return;
    }
  ...
  if (strcmp(sub, "circle") == 0) {
    if (argc < 5) {
      printf("usage: oled circle <cx> <cy> <r>\n");
      return;
    }
  ...
  if (strcmp(sub, "circlefill") == 0) {
    if (argc < 5) {
      printf("usage: oled circlefill <cx> <cy> <r>\n");
      return;
    }
  ...
  if (strcmp(sub, "progress") == 0) {
    if (argc < 7) {
      printf("usage: oled progress <x> <y> <w> <h> <pct>\n");
      return;
    }
  ...
  if (strcmp(sub, "status") == 0) {
    if (argc < 4) {
      printf("usage: oled status <left> <right>\n");
      return;
    }
  ...
  if (strcmp(sub, "splash") == 0) {
    if (argc < 4) {
      printf("usage: oled splash <line1> <line2>\n");
      return;
    }
  ...
  if (strcmp(sub, "notify") == 0) {
    if (argc < 4) {
      printf("usage: oled notify <msg> <ms>\n");
      return;
    }
  ...
  if (strcmp(sub, "scroll") == 0) {
    if (argc < 3) {
      printf("usage: oled scroll right|left <sp> <ep>  |  oled scroll stop\n");
      return;
    }
    if (strcmp(argv[2], "stop") == 0) {
      oled_scroll_stop();
      printf("oled: scroll stopped\n");
      return;
    }
    if (argc < 5) {
      printf("usage: oled scroll right|left <start_page> <end_page>\n");
      return;
    }
    ...
    if (strcmp(argv[2], "right") == 0) oled_scroll_right(sp, ep);
      ...
      printf("oled scroll: direction must be right|left\n");
      return;
    }
  ...
  if (strcmp(sub, "spinner") == 0) {
    if (argc < 5) {
      printf("usage: oled spinner <x> <y> <frame 0-7>\n");
      return;
    }
...
static void cmd_wifi(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "post") == 0) {
    if (argc < 4) {
      printf("usage: wifi post <url> <body>\n");
      return;
    }
  ...
  if (strcmp(argv[1], "deinit") == 0) {
    if (!esp8266_is_ready()) {
      printf("wifi: already deinitialised\n");
      return;
    }
    esp8266_deinit();
...
static void cmd_sysinfo(int argc, char * argv[]) {
  ...
  board_info_t b = board_detect();
  printf("=================================\n");
  printf("  DeckOS v5.0  -  system info  \n");
  printf("=================================\n");
  printf("board   : %s\n", b.name);
  printf("cpu     : RP2040  dual-core Cortex-M0+  %lu MHz\n", b.cpu_mhz);
  printf("ram     : %lu KB SRAM\n", b.sram_kb);
  printf("flash   : %lu KB  (%lu MB)\n", b.flash_kb, b.flash_kb / 1024);
  printf("uptime  : ");
  print_uptime();
  printf("\n");
...
static void cmd_mkdir(int argc, char * argv[]) {
  if (argc < 2) {
    printf("usage: mkdir <dir> [dir2 ...]\n");
    return;
  }
  bool changed = false;
  for (int a = 1; a < argc; a++) {
    if (vfs_mkdir(argv[a]) >= 0) {
...
static void cmd_rm(int argc, char * argv[]) {
  ...
  if (start >= argc) {
    printf("rm: missing path argument\n");
    return;
  }
  bool changed = false;
...
static bool interactive_write(const char * path) {
  ...
  if (total == 0) {
    printf("iwrite: empty content -- nothing written\n");
    return false;
  }
...
static void cmd_pwm(int argc, char * argv[]) {
  if (argc < 3) {
    printf("usage: pwm <pin> <duty 0-100> [freq_hz]\n");
    return;
  }
  int pin = atoi(argv[1]);
  ...
  if (freq < 1 || freq > 62500000) {
    printf("freq must be 1-62500000 Hz\n");
    return;
  }
  ...
  uint32_t wrap = 65535;
  float clkdiv = (float) sys_clk / ((wrap + 1) * freq);

  while (clkdiv < 1.0f && wrap > 1000) {
    wrap /= 2;
    clkdiv = (float) sys_clk / ((wrap + 1) * freq);
  }

  pwm_set_clkdiv(slice, clkdiv);
  pwm_set_wrap(slice, wrap);
  pwm_set_gpio_level(pin, (duty * wrap) / 100);
...
static void cmd_gpio(int argc, char * argv[]) {
  if (argc < 3) {
    printf("usage: gpio <read|write|mode|irq> <pin> [val]\n");
    return;
  }
...
static void cmd_adc(int argc, char * argv[]) {
  if (argc < 2) {
    printf("usage: adc <0|1|2>  (GPIO26-28)\n");
    fflush(stdout);
    return;
  }
  int ch = atoi(argv[1]);
  if (ch < 0 || ch > 2) {
    printf("channel must be 0-2\n");
    fflush(stdout);
    return;
  }
  adc_init();
...
static void cmd_i2c(int argc, char * argv[]) {
  if (argc < 2) {
    ...
    printf("  i2c dump  <addr>                  - dump 256 registers\n");
    return;
  }
  ...
  if (strcmp(argv[1], "scan") == 0) {
    ...
    i2c_inst_t * bus;
    bool valid = false;
    if ((sda % 4 == 0) && (scl == sda + 1)) {
      bus = i2c0;
      valid = true;
    } else if ((sda % 4 == 2) && (scl == sda + 1)) {
      bus = i2c1;
      valid = true;
    } else {
    ...
    if (argc < 4) {
      printf("usage: i2c read <addr_hex> <reg_hex> [sda] [scl]\n");
      return;
    }
    ...
    if (argc < 5) {
      printf("usage: i2c write <addr_hex> <reg_hex> <val_hex> [sda] [scl]\n");
      return;
    }
    uint8_t addr = (uint8_t) strtol(argv[2], NULL, 16);
    uint8_t reg = (uint8_t) strtol(argv[3], NULL, 16);
    ...
    if (argc < 3) {
      printf("usage: i2c dump <addr_hex> [sda] [scl]\n");
      return;
    }
    ...
    for (int row = 0; row < 16; row++) {
      ...
      for (int col = 0; col < 16; col++) {
        ...
        int ret = i2c_write_timeout_us(
          bus, addr, & reg, 1, true, 2000
        );

        if (ret >= 0) {
          ret = i2c_read_timeout_us(
            bus, addr, & val, 1, false, 2000
          );
        }
...
static void cmd_servo(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "bg") == 0) {
    if (argc < 3) {
      printf("servo bg: need subcommand\n");
      return;
    }
    ...
    if (argc < 4) {
      printf("servo bg <pin> sweep|goto|stop\n");
      return;
    }
    ...
    if (strcmp(argv[3], "sweep") == 0) {
      ...
      if (argc < 5) {
        printf("servo bg <pin> goto <angle> [step_ms]\n");
        return;
      }
      ...
      if (slot < 0) {
        printf("no background servo on GPIO%d\n", pin);
        return;
      }
      servo_bg_stop(slot);
  ...
  if (strcmp(argv[1], "sweep") == 0) {
    if (argc < 3) {
      printf("servo sweep <pin> [from to step_ms]\n");
      return;
    }
    int pin = atoi(argv[2]);
  ...
  if (argc < 3) {
    printf("usage: servo <pin> <angle 0-180>\n");
    return;
  }
  int pin = atoi(argv[1]);
...
static void cmd_spi(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "read") == 0) {
    if (argc < 4) {
      printf("spi read <cs_pin> <reg_hex> [len]\n");
      return;
    }
    uint cs = (uint) atoi(argv[2]);
    uint8_t reg = (uint8_t) strtol(argv[3], NULL, 16);
  ...
  for (int r = 0; r < 20; r++) {
    ...
    if (left[r].gp >= 0) {
      printf("  |  %c  %c  %c   %-4s  [%02d] |===| [%02d]  %-4s   %c  %c  %c  |\n",
        ...
        rphy, rlabel, rdir, rfc, rval);
    } else {
      printf("  |            %-4s  [%02d] |===| [%02d]  %-4s             |\n",
        llabel, lphy, rphy, rlabel);
    }
  }
...
static void cmd_piano(int argc, char * argv[]) {
  ...
  static
  const uint32_t NOTE_TABLE[8][12] = {
    {
      16,
      17,
      18,
  ...
  static
  const int num_keys = (int)(sizeof(keys) / sizeof(keys[0]));
  ...
  while (true) {
    ...
    if (found >= 0) {
      ...
      printf("  | ");
      static
      const char all_keys[] = "wsedtyhujokp";
...
static void cmd_flash(int argc, char * argv[]) {
  if (argc < 3) {
    ...
    board_info_t b = board_detect();
    uint32_t config_sector = (b.flash_kb * 1024) - 4096;
    printf("  config sector is at 0x%06lX - do not erase it manually\n",
      config_sector);
    fflush(stdout);
    return;
  }
  ...
  if (strcmp(argv[1], "read") == 0) {
    if (argc < 4) {
      printf("flash read <addr_hex> <len>\n");
      fflush(stdout);
      return;
    }
    int len = atoi(argv[3]);
  ...
  if (strcmp(argv[1], "write") == 0) {
    if (argc < 4) {
      printf("flash write <addr_hex> <hex bytes...>\n");
      fflush(stdout);
      return;
    }
...
static void cmd_watch(int argc, char * argv[]) {
  ...
  int ms = atoi(argv[1]);
  if (ms < 10 || ms > 60000) {
    printf("interval must be 10-60000 ms\n");
    return;
  }
...
static void cmd_module(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "load") == 0) {
    if (argc < 3) {
      printf("usage: module load <name>\n");
      return;
    }
    module_load(argv[2]);
  } else if (strcmp(argv[1], "unload") == 0) {
    if (argc < 3) {
      printf("usage: module unload <name>\n");
      return;
    }
    module_unload(argv[2]);
  } else {
    printf("module: load | unload | list\n");
  }
}

static void cmd_edit(int argc, char * argv[]) {
  if (!editor_is_loaded()) {
    printf("edit: editor module not loaded\n");
    printf("  run 'module load editor' first (frees ~96 KB when unloaded)\n");
    return;
  }
  if (argc < 2) {
...
static void cmd_syslog(int argc, char * argv[]) {
  ...
  if (strcmp(argv[1], "warn") == 0) {
    syslog_dump(LOG_WARN, 0);
    fflush(stdout);
    return;
  }
  if (strcmp(argv[1], "err") == 0) {
    syslog_dump(LOG_ERR, 0);
    fflush(stdout);
    return;
  }
...
static void la_trigger_job(void * arg) {
  ...
  while (!gpio_get(pin)) {
    if (bg_job_cancel_requested(a -> slot)) {
      free(buf);
      return;
    }
...
static void cmd_la(int argc, char * argv[]) {
  ...
  if (samples < 8 || samples > 512) {
    printf("samples: 8-512\n");
    fflush(stdout);
    return;
  }
  if (us_per_sample < 1 || us_per_sample > 100000) {
    printf("us_per_sample: 1-100000\n");
    fflush(stdout);
    return;
  }
...
static void cmd_trigger(int argc, char * argv[]) {
  ...
  if (strcmp(argv[2], "rise") == 0) mask = GPIO_IRQ_EDGE_RISE;
    ...
    printf("edge must be rise|fall|both\n");
    return;
  }
...
static void cmd_scope(int argc, char * argv[]) {
  if (argc < 4) {
    printf("usage: scope <pin> <expected_hz> <duration_ms>\n");
    printf("       scope 15 1000 50    - view 1kHz signal for 50ms\n");
    printf("       scope 15 50 500     - view 50Hz signal for 500ms\n");
    fflush(stdout);
    return;
  }

  int pin = atoi(argv[1]);
  int expected_hz = atoi(argv[2]);
  ...
  if (expected_hz < 1 || expected_hz > 500000) {
    printf("hz: 1-500000\n");
    fflush(stdout);
    return;
  }
  if (duration_ms < 1 || duration_ms > 10000) {
    printf("duration: 1-10000 ms\n");
    fflush(stdout);
    return;
  }

  uint32_t us_per_sample = (uint32_t)(1000000 / (expected_hz * 5));
  if (us_per_sample < 1) us_per_sample = 1;
  uint32_t total_us = (uint32_t)(duration_ms * 1000);
  uint32_t n_samples = total_us / us_per_sample;
  if (n_samples < 8) n_samples = 8;
  if (n_samples > 512) n_samples = 512;
  ...
  printf("scope: GPIO%d  ~%d Hz  %d ms  (%lu samples @ %lu us)\n",
    pin, expected_hz, duration_ms, n_samples, us_per_sample);
  fflush(stdout);
  ...
  float window_ms = (float)(n_samples * us_per_sample) / 1000.0f;
  float us_per_div = (float)(n_samples * us_per_sample) / 8.0f;
  ...
  printf("    |");
  uint32_t div_step = n_samples / 8;
  for (uint32_t i = 1; i < n_samples; i++) {
    if (i % div_step == 0) printf("|");
    else printf("-");
  }
  printf("\n    0");
  for (int d = 1; d <= 8; d++) {
    float t = (us_per_div * d) / 1000.0f;
    if (t < 1.0f)
      printf("%*s%.0fus", (int)(div_step - 4), "", us_per_div * d);
    else
      printf("%*s%.1fms", (int)(div_step - 5), "", t);
  }
  printf("\n\n");
  fflush(stdout);
  ...
  float duty = (float) highs / (float) n_samples * 100.0f;
  printf("  window   : %.2f ms\n", window_ms);
  printf("  edges    : %d\n", edges);
  printf("  duty     : %.1f%%\n", duty);
  if (edges >= 2) {
    float measured_hz = (float) edges / 2.0f / (window_ms / 1000.0f);
    printf("  measured : %.1f Hz\n", measured_hz);
  }
  printf("  expected : %d Hz\n\n", expected_hz);
  fflush(stdout);
...
static void cmd_power(int argc, char * argv[]) {
  ...
  uint32_t sum = 0;
  for (int i = 0; i < 64; i++) sum += adc_read();
  uint16_t raw = (uint16_t)(sum / 64);
  float adc_v = raw * 3.3f / 4096.0f;
  float vsys = adc_v * 3.0f;
  ...
  if (vsys >= 4.5f && vsys <= 5.5f) {
    printf("  source      : USB (%.2f V)\n", vsys);
  } else if (vsys >= 3.0f && vsys < 4.5f) {
    printf("  source      : battery (likely)\n");
    float lipo_pct = (vsys - 3.0f) / (4.2f - 3.0f) * 100.0f;
    if (lipo_pct > 100.0f) lipo_pct = 100.0f;
    if (lipo_pct < 0.0f) lipo_pct = 0.0f;
    printf("  1S LiPo est : %.0f%%  (3.0V=0%% 4.2V=100%%)\n", lipo_pct);
    float aa_pct = (vsys - 3.0f) / (4.5f - 3.0f) * 100.0f;
    if (aa_pct > 100.0f) aa_pct = 100.0f;
    if (aa_pct < 0.0f) aa_pct = 0.0f;
    printf("  3xAA est    : %.0f%%  (3.0V=0%% 4.5V=100%%)\n", aa_pct);
  } else if (vsys < 3.0f) {
    printf("  source      : WARNING -- voltage dangerously low (%.2f V)\n", vsys);
  } else {
    printf("  source      : external / unknown\n");
  }
  printf("\n  note: GP29/ADC3 must be free (not driven externally)\n");
  fflush(stdout);
}
...
static void cmd_stack(int argc, char * argv[]) {
  ...
  uint32_t used = stack_top - sp;
  uint32_t free_b = sp - stack_limit;
  float pct = (float) used / (float) stack_total * 100.0f;

  printf("stack usage (Core 0):\n");
  printf("  top        : 0x%08lX\n", stack_top);
  printf("  limit      : 0x%08lX\n", stack_limit);
  printf("  size       : %lu B  (%lu KB)\n", stack_total, stack_total / 1024);
  printf("  SP now     : 0x%08lX\n", sp);
  printf("  used       : %lu B  (%.1f%%)\n", used, pct);
  printf("  free       : %lu B\n", free_b);

  if (free_b < 256)
    printf("  WARNING: stack headroom critically low (<256 B)\n");
  else if (free_b < 512)
    printf("  WARNING: stack headroom low (<512 B)\n");
  ...
  if (hwm != 0) {
    uint32_t peak_used = stack_top - hwm;
    printf("  peak used  : %lu B  (%.1f%%)  [canary watermark]\n",
      peak_used, (float) peak_used / (float) stack_total * 100.0f);
  } else {
    printf("  peak used  : unknown (stack not pre-filled with canary)\n");
    printf("  tip: fill stack with 0xDEADBEEF at boot for watermark tracking\n");
  }
  fflush(stdout);
}

static volatile uint32_t s_fault_pc = 0;
static volatile uint32_t s_fault_lr = 0;
static volatile uint32_t s_fault_sp = 0;
static volatile uint32_t s_fault_r0 = 0;
static volatile uint32_t s_fault_r12 = 0;
static volatile uint32_t s_fault_xpsr = 0;
...
void hardfault_c(uint32_t * frame) {
  ...
  s_fault_lr = frame[5];
  s_fault_pc = frame[6];
  s_fault_xpsr = frame[7];
  s_fault_sp = (uint32_t) frame;
  ...
  printf("EXC : 0x%08lX  (%s)\n", frame[5],
    (frame[5] & 0xF) == 0x9 ? "Core0-MSP" :
    (frame[5] & 0xF) == 0xD ? "Core0-PSP" : "Core1?");
  for (volatile int i = 0; i < 1000000; i++) {}

  char buf[64];
  snprintf(buf, sizeof(buf), "PC=0x%08lX LR=0x%08lX SP=0x%08lX",
    s_fault_pc, s_fault_lr, s_fault_sp);
  syslog_write(LOG_ERR, "HARDFAULT", buf);
...
static void cmd_fault(int argc, char * argv[]) {
  if (argc >= 2 && strcmp(argv[1], "info") == 0) {
    if (s_fault_pc == 0) {
      printf("no fault recorded this session\n");
      printf("check syslog for faults from previous boots:\n");
      printf("  syslog err\n");
      return;
    }
    printf("last fault this session:\n");
  ...
  if (argc >= 2 && strcmp(argv[1], "test") == 0) {
    printf("triggering intentional fault in 1s...\n");
    printf("board will reboot; check 'syslog err' after\n");
    sleep_ms(1000);
  ...
  printf("usage:\n");
  printf("  fault info   - show registers from last fault this session\n");
  printf("  fault test   - trigger a deliberate fault to test the handler\n");
  printf("\n");
  printf("the fault handler auto-installs at boot and logs to syslog.\n");
  printf("after an unexpected reboot, run 'syslog err' to see the cause.\n");
}
...
static void cmd_time(int argc, char * argv[]) {
  if (argc < 2) {
    ...
    printf("       runs the command and prints elapsed wall-clock time\n");
    return;
  }
  char sub[INPUT_SIZE];
  sub[0] = '\0';
  for (int i = 1; i < argc; i++) {
    if (i > 1) strncat(sub, " ", sizeof(sub) - strlen(sub) - 1);
    strncat(sub, argv[i], sizeof(sub) - strlen(sub) - 1);
  }
  uint64_t t0 = time_us_64();
  commands_execute(sub);
  uint64_t dt = time_us_64() - t0;
  printf("\ntime: %lu.%03lu ms  (%llu us)\n",
    (uint32_t)(dt / 1000), (uint32_t)(dt % 1000),
    (unsigned long long) dt);
  fflush(stdout);
}

static bool s_rtc_started = false;

static int dow_calc(int y, int m, int d) {
  static
  const int t[] = {
    0,
    3,
...
static void rtc_ensure_started(void) {
  if (s_rtc_started) return;
  rtc_init();
...
static void cmd_date(int argc, char * argv[]) {
  ...
  if (argc >= 2 && strcmp(argv[1], "set") == 0) {
    if (argc < 8) {
      ...
      printf("   eg: date set 2026 5 30 19 45 00\n");
      return;
    }
    datetime_t t = {
      .year = (int16_t) atoi(argv[2]),
      .month = (int8_t) atoi(argv[3]),
      .day = (int8_t) atoi(argv[4]),
      .hour = (int8_t) atoi(argv[5]),
      .min = (int8_t) atoi(argv[6]),
      .sec = (int8_t) atoi(argv[7]),
    };
    t.dotw = (int8_t) dow_calc(t.year, t.month, t.day);
    if (t.month < 1 || t.month > 12 || t.day < 1 || t.day > 31 ||
      t.hour < 0 || t.hour > 23 || t.min < 0 || t.min > 59 ||
      t.sec < 0 || t.sec > 59) {
      printf("date: values out of range\n");
      return;
    }
    if (!rtc_set_datetime( & t)) {
      printf("date: RTC rejected value\n");
      return;
    }
    sleep_us(64);
    printf("clock set.\n");
  ...
  if (!rtc_get_datetime( & now)) {
    printf("date: RTC not running\n");
    return;
  }
  char buf[64];
  datetime_to_str(buf, sizeof(buf), & now);
  printf("%s\n", buf);
  printf("note: RP2040 RTC is not battery-backed - time resets on power loss\n");
  fflush(stdout);
}
...
static void cmd_uname(int argc, char * argv[]) {
  ...
  if (argc >= 2 && (strcmp(argv[1], "-a") == 0 || strcmp(argv[1], "-all") == 0)) {
    printf("DeckOS 3.0 %s RP2040 Cortex-M0+ %luMHz SRAM=%luKB flash=%luKB %s\n",
      g_config.hostname, b.cpu_mhz, b.sram_kb, b.flash_kb, b.name);
  } else {
    printf("DeckOS\n");
  }
  fflush(stdout);
...
static void cmd_rand(int argc, char * argv[]) {
  if (argc >= 2 && (strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "help") == 0)) {
    printf("usage:\n");
    printf("  rand              - random 32-bit value\n");
    printf("  rand <max>        - 0 .. max-1\n");
    printf("  rand <min> <max>  - inclusive range\n");
    return;
  }
...
s_aliases[MAX_ALIASES];

static
const char * alias_lookup(const char * name) {
  for (int i = 0; i < MAX_ALIASES; i++)
    if (s_aliases[i].used && strcmp(s_aliases[i].name, name) == 0)
      return s_aliases[i].val;
  return NULL;
}
...
static void cmd_alias(int argc, char * argv[]) {
  ...
  if (argc < 2) {
    ...
    for (int i = 0; i < MAX_ALIASES; i++)
      if (s_aliases[i].used) {
        printf("  %-12s = %s\n", s_aliases[i].name, s_aliases[i].val);
        n++;
      }
    if (!n) printf("no aliases defined  (alias <name> <command...>)\n");
    return;
  }
  ...
  if (argc == 2) {
    ...
    if (v) printf("  %-12s = %s\n", argv[1], v);
    else printf("alias '%s' not defined\n", argv[1]);
    return;
  }

  if (strlen(argv[1]) >= ALIAS_NAME_LEN) {
    printf("alias name too long (max %d)\n", ALIAS_NAME_LEN - 1);
    return;
  }
  ...
  int slot = -1;
  for (int i = 0; i < MAX_ALIASES; i++)
    if (s_aliases[i].used && strcmp(s_aliases[i].name, argv[1]) == 0) {
      slot = i;
      break;
    }
  if (slot < 0)
  ...
  if (slot < 0) {
    printf("alias table full (%d max)\n", MAX_ALIASES);
    return;
  }

  s_aliases[slot].used = true;
  strncpy(s_aliases[slot].name, argv[1], ALIAS_NAME_LEN - 1);
  s_aliases[slot].name[ALIAS_NAME_LEN - 1] = '\0';
  strncpy(s_aliases[slot].val, val, ALIAS_VAL_LEN - 1);
  s_aliases[slot].val[ALIAS_VAL_LEN - 1] = '\0';
  printf("alias '%s' -> '%s'\n", s_aliases[slot].name, s_aliases[slot].val);
}
...
static command_t command_table[] = {
  ...
  },
  {
    "version",
    cmd_version,
    "show OS version and build info"
  },
  {
    "clear",
    cmd_clear,
  ...
  },
  {
    "top",
    cmd_top,
    "live task monitor (any key to exit)"
  },
  {
    "jobs",
    cmd_jobs,
    "jobs  list background jobs | jobs cancel <id>"
  },

  {
    "temp",
    cmd_temp,
    "read internal core temperature"
  },
  {
    "mem",
    cmd_mem,
  ...
  },
  {
    "free",
    cmd_free,
    "heap allocator stats and live allocs"
  },
  {
    "stack",
    cmd_stack,
    "stack  Core0 stack depth and high-water mark"
  },
  {
    "led",
    cmd_led,
  ...
  },
  {
    "gpio",
    cmd_gpio,
    "gpio <read|write|mode|irq> <pin> [val]"
  },
  {
    "pwm",
    cmd_pwm,
  ...
  },
  {
    "adc",
    cmd_adc,
    "adc <ch 0-2>  raw ADC read"
  },
  {
    "avg",
    cmd_avg,
    "avg <ch> [samples]  averaged ADC read"
  },
  {
    "power",
    cmd_power,
  ...
  },
  {
    "clock",
    cmd_clock,
    "clock [mhz]  get/set CPU freq (48-200)"
  },
  {
    "i2c",
    cmd_i2c,
    "i2c scan [sda scl] | read [sda scl] | write [sda scl]"
  },
  {
    "spi",
    cmd_spi,
    "spi init|write|read|xfer  SPI bus ops"
  },
  {
    "uart",
    cmd_uart,
    "uart <baud> <tx> <rx> [timeout_s]  passthrough"
  },
  {
    "pinout",
    cmd_pinout,
    "ASCII Pico pinout with live pin states"
  },
  {
    "flash",
    cmd_flash,
    "flash read|write|erase <addr> raw flash access"
  },
  {
    "detect",
    cmd_detect,
    "scan and report connected devices"
  },
  {
    "la",
    cmd_la,
    "la <pin> [samples] [us]  logic analyser + timing diagram"
  },
  {
    "scope",
    cmd_scope,
  ...
  },
  {
    "watch",
    cmd_watch,
    "watch <ms> <cmd>  run cmd at interval"
  },
  {
    "trigger",
    cmd_trigger,
  ...
  },
  {
    "cron",
    cmd_cron,
    "cron <delay_ms> <cmd>  deferred run"
  },
  {
    "bench",
    cmd_bench,
    "bench <iters> <cmd>  measure cmd throughput"
  },
  {
    "time",
    cmd_time,
  ...
  },
  {
    "alias",
    cmd_alias,
    "alias [name [cmd...]]  define/list command aliases"
  },
  {
    "unalias",
    cmd_unalias,
  ...
  },
  {
    "dfu",
    cmd_dfu,
    "reboot into USB DFU (BOOTSEL)"
  },
  {
    "uid",
    cmd_uid,
    "show unique board ID"
  },
  {
    "wdog",
    cmd_wdog,
  ...
  },
  {
    "fault",
    cmd_fault,
    "fault info|test  HardFault register dump"
  },
  {
    "pin",
    cmd_pin,
    "dump all GPIO pin states"
  },
  {
    "date",
    cmd_date,
  ...
  },
  {
    "history",
    cmd_history,
    "history [clear]  show command history"
  },
  {
    "uname",
    cmd_uname,
  ...
  },
  {
    "script",
    cmd_script,
    "script run|test  DeckScript interpreter"
  },
  ...
  },
  {
    "write",
    cmd_write,
    "write <file> <text>  write (overwrite) text to file"
  },
  {
    "iwrite",
    cmd_iwrite,
    "iwrite <file>  interactive multi-line write (end with '.')"
  },
  {
    "append",
    cmd_append,
  ...
  },
  {
    "edit",
    cmd_edit,
    "edit <file>  nano-style text editor (needs 'module load editor')"
  },
  {
    "module",
    cmd_module,
    "module load|unload|list  manage optional RAM-heavy modules"
  },
  {
    "wc",
    cmd_wc,
  ...
  },
  {
    "save",
    cmd_save,
    "save VFS to flash (persist across reboots)"
  },

  {
    "usb",
    cmd_usb,
    "usb status|list|export|import|sync|rm|format  USB mass storage"
  },
  {
    "hid",
    cmd_hid,
    "hid type|line|key|enter  act as a USB keyboard"
  },
  {
    "console",
    cmd_console,
...
void commands_execute(char * input) {
  ...
  const char * arepl = alias_lookup(argv[0]);
  if (arepl) {
    char expanded[INPUT_SIZE];
    int n = snprintf(expanded, sizeof(expanded), "%s", arepl);
    for (int i = 1; i < argc && n < (int) sizeof(expanded) - 1; i++)
      n += snprintf(expanded + n, sizeof(expanded) - (size_t) n, " %s", argv[i]);
